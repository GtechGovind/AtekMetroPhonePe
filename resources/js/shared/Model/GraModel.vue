                        ...
                        <div class="h-full bg-white p-3 rounded-lg">
                            <div class="m-2">
                                <table class="w-full rounded-lg">
                                    ...
                                    <tr v-if = showTravelPenalty class="bg-white border-b">
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap">
                    ...
                    if (penalties.length && overTravelCharges.length)
                    {
                        ...
                        penalties.forEach((penalty) => {
                            ...
                            if (this.gra.TravelPenalty !== 0){
                                ...
                                this.gra.TravelpenaltyName = '• Over Travel Penalty = ₹' + this.gra.TravelPenalty
                        ...
                        if(this.gra.totalAmount > 50){
                            this.gra.totalAmount = 50
                        }
